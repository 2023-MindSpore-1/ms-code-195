...
def parse_arguments():
    """parse_arguments"""
    global args
    parser = argparse.ArgumentParser(description="MindSpore EfficientNetV2 Training")
    parser.add_argument("-a", "--arch", metavar="ARCH", default="effnetv2_s", help="model architecture")
    ...
    parser.add_argument('--clip_global_norm_value', default=0., type=float, help='clip_global_norm_value.')
    ...
    parser.add_argument("--set", help="name of dataset", type=str, default="ImageNetFinetune")
    ...
    parser.add_argument("--cutmix", default=0., type=float, help="cutmix")
    ...
    parser.add_argument("--min_lr", "--min learning_rate", default=0, type=float, help="min lr", dest="min_lr")
    ...
    parser.add_argument("--label_smoothing", type=float, help="Label smoothing to use, default 0.1", default=0.)
    parser.add_argument("--drop_out_rate", type=float, help="drop_out_rate", default=0.0)
    parser.add_argument("--drop_path_rate", type=float, help="drop_path_rate", default=0.2)
    parser.add_argument("--auto_augment", type=str, help="auto_augment", default=None)
    parser.add_argument("--image_size", default=300, help="Image Size.", type=int)
    parser.add_argument("--input_image_size", default=128, help="Image Size.", type=int)
...
def get_config():
    ...
    print(f"DEVICE_NUM: {os.getenv('DEVICE_NUM')} RANK_SIZE: {os.getenv('RANK_SIZE')}")
